package com.tenco.csr_blog_v1.core.handlr;

import com.tenco.csr_blog_v1.core.handlr.errors.*;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(BadRequestException.class) //400번이 보이면 여기로
